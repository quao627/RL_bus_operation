...
class Env(gym.Env):
    def __init__(self, 
                 mode='headway', 
                 difficulty_level=0, 
                 action_values=[[0, 1, 2, 3], [1, 2, 3], [0, 1, 2, 4]],
                 action_difficulty_thresholds=[0.5, 0.1, 0.5]) -> None:
        ...
        self.action_mask = [i in self.action_values[self.difficulty_level] for i in range(self.action_space.n)]
