...
class MaskableRecurrentRolloutBuffer(RolloutBuffer):
    """
    ...
    def _get_samples(
        ...
        return MaskableRecurrentRolloutBufferSamples(
            ...
            action_masks=self.pad_and_flatten(self.action_masks[batch_inds].reshape(-1, self.mask_dims)).reshape(-1, self.mask_dims),
        )
